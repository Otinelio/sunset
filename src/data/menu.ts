...
export const MENU: MenuItem[] = [
  ...
  { id: "c3", category: "cocktails", name: "Atlantic Blue", description: "Rhum blanc, curaçao bleu, ananas, citron", price: 5000, image: img("photo-1587223962930-cb7f31384c19") },
  { id: "c4", category: "cocktails", name: "Lomé Sour", description: "Whisky, citron, sirop de canne, blanc d'oeuf", price: 6000, image: img("photo-1536935338788-846bb9981813") },
  ...
  { id: "m2", category: "mocktails", name: "Coconut Beach", description: "Lait de coco, ananas, citron vert", price: 4000, image: img("photo-1546171753-97d7676e4602") },
  ...
  { id: "s2", category: "spiritueux", name: "Rhum vieux", description: "Verre 4cl", price: 4000, image: img("photo-1569529465841-dfecdab7503b") },
  ...
  { id: "f2", category: "cuisine", name: "Crevettes sautées au piment doux", description: "Servies avec citron vert", price: 7000, image: img("photo-1565299624946-b28f40a0ae38") },
  { id: "f3", category: "cuisine", name: "Plateau de fruits de mer", description: "Pour 2 personnes", price: 12000, image: img("photo-1559737558-2f5a35f4523b") },
  ...
  { id: "t2", category: "snacks", name: "Spring rolls", description: "4 pièces, sauce aigre-douce", price: 3000, image: img("photo-1606471191009-63994c53433b") },
  ...
  { id: "t4", category: "snacks", name: "Ailes de poulet épicées", description: "Sauce maison piquante", price: 4000, image: img("photo-1567620832903-9fc6debc209f") },
];
